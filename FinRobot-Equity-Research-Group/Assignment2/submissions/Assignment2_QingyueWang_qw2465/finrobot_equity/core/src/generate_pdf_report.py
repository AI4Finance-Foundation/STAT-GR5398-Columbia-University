...
def load_analysis_data(analysis_dir: str, ticker: str) -> Dict[str, Any]:
    ...
    text_files = {
        ...
        'thesis_tracker': 'thesis_tracker.md',
        'catalyst_calendar': 'catalyst_calendar.md',
        'earnings_update': 'earnings_update.md',
    }
...
def main():
    ...
    report_data = {
        ...
        'thesis_tracker': loaded_data.get('thesis_tracker', ''),
        'catalyst_calendar': loaded_data.get('catalyst_calendar', ''),
        'earnings_update': loaded_data.get('earnings_update', ''),
