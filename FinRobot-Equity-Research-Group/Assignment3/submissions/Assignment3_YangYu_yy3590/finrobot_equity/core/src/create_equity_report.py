...
from modules.market_data_api import configure_fmp_runtime
...
def main():
    ...
    parser.add_argument("--fmp-cache-policy", type=str, default="same-day", choices=["same-day", "reuse-until-forced"], help="FMP cache reuse policy for auto-fetched market data.")
    parser.add_argument("--force-refresh-fmp", action="store_true", help="Bypass FMP cache for auto-fetched market data.")
